...
public class PhysicalAp4R4EvidenceTests
{
    ...
    public void AP4R4_Hydraulic_FaultDirectionOnRecovery_IsSeparated()
    {
        ...
        {
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Initiating), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 152 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 1.0 } },
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Initiating), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 151 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 1.0 } },
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Developing), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 150 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 1.0 } },
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Developing), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 149 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.98 } },
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Degraded), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 148 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.95 } },
            new() { LifecycleStage = "PreFault", ScenarioPhase = nameof(FaultScenarioPhase.Degraded), MachineState = nameof(MachineState.Running), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 146 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.9 } },
            new() { LifecycleStage = "Faulted", ScenarioPhase = nameof(FaultScenarioPhase.Critical), ErrorActive = true, MachineState = nameof(MachineState.Error), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 112 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.58 } },
            new() { LifecycleStage = "Faulted", ScenarioPhase = nameof(FaultScenarioPhase.Faulted), ErrorActive = true, MachineState = nameof(MachineState.Error), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 105 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.55 } },
            new() { LifecycleStage = "Faulted", ScenarioPhase = nameof(FaultScenarioPhase.Faulted), ErrorActive = true, MachineState = nameof(MachineState.Error), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 104 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.52 } },
            new() { LifecycleStage = "RecoveryStart", ScenarioPhase = nameof(FaultScenarioPhase.Recovering), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 115 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.7 } },
            new() { LifecycleStage = "RecoveryMid", ScenarioPhase = nameof(FaultScenarioPhase.Recovering), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 130 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.85 } },
            new() { LifecycleStage = "RecoveryMid", ScenarioPhase = nameof(FaultScenarioPhase.Recovering), Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 135 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.9 } },
            new() { LifecycleStage = "PostRecovery", Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 142 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.92 } },
            ...
            new() { LifecycleStage = "PostRecovery", Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 147 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.97 } },
            new() { LifecycleStage = "PostRecovery", Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 148 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.98 } },
            new() { LifecycleStage = "PostRecovery", Signals = new Dictionary<string, double> { ["Hydraulic.SupplyPressure"] = 149 }, HiddenStates = new Dictionary<string, double> { ["HydraulicEfficiency"] = 0.99 } },
        };
